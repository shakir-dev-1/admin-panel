...
export default function Payments() {
  ...
  // Fetch clients for selected business
    ...
    try {
      ...
      const response = (await postWithAuth(
        ...
        token,
        {
          ...
          clientId: paymentForm.clientId || undefined, // Send undefined if empty to create test client
        },
      )) as CreatePaymentResponse;

      toast.success("Test payment created successfully", {
        id: toastId,
        description: `Payment created for ${response.clientName} with status: ${response.status}`,
      });
      ...
      <AlertDialog open={showCreatePayment} onOpenChange={setShowCreatePayment}>
        <AlertDialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            {/* Client Selection - Only show when business is selected */}
            {paymentForm.businessId && (
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    // If they select the special value, set clientId to empty string
                    if (value === "__create_test_client__") {
                ...
                >
                  ...
                  <SelectContent>
                    {loadingClients ? (
                      ...
                      <>
                        <SelectItem value="__create_test_client__">
                          ✨ Create test client
                        </SelectItem>
                        {clients.map((client) => (
                ...
                <p className="text-xs text-muted-foreground">
                  Leave empty to create a test client automatically
                </p>
              </div>
            )}
            ...
            <div className="grid gap-2">
              <label htmlFor="amount" className="text-sm font-medium">
                Amount (in dollars) <span className="text-red-500">*</span>
              </label>
              <input
                id="amount"
                type="number"
